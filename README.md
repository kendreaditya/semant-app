...
```bash
git clone git@github.com:[YOUR_GITHUB_ACCOUNT]/semant.git
```
...
We welcome contributions from the community! If you'd like to contribute to Semant, please follow these steps:
